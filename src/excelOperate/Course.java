...
public class Course
{
	...
	public static String solveOneClass(String classStrings)
	{ // 获得某一格子的课程信息
		String aString = "";
	...
	public static String addOneClass(String a)
	{ // 获得"1-15,17-18周,单周"类型字符串，确定其使用周数
		...
		for (int i = 0; i < num; i++)
		{ // numString 1-15 16 17-18 19周 单周
			if (numString[i].contains("-"))
			{ // 为A-B格式
	...
	public static int changeToInt(String a)
	{ // 將字符串改為數字 例如： 字符串“12”變為數字12
