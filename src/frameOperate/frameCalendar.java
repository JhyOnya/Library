...
public class frameCalendar extends JPanel{
    ...
    private static final String DEFAULTFORMAT = "yyyy年MM月dd日";
    ...
    private static Color hoverColor = new Color(148, 0, 211); // hover color
    
    
    private frameCalendar(java.util.Date date, String format, int startDAY){
    ...
    public static frameCalendar getInstance(java.util.Date date, String format){
        return new frameCalendar(date, format, defaultStartDAY);
    }

    public static frameCalendar getInstance(java.util.Date date){
        return getInstance(date, DEFAULTFORMAT);
    }
    public static frameCalendar getInstance(String format){
        return getInstance(new java.util.Date(), format);
    }
    public static frameCalendar getInstance(){
    ...
    private class LabelManager {
        ...
        public LabelManager(){
            list = new ArrayList<frameCalendar.DayLabel>();
        }
    ...
    public static void main(String[] args) {
        ...
        frameCalendar ser2 = frameCalendar.getInstance("yyyy年MM月dd日");
